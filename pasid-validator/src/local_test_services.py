...
def mostrar_ajuda() -> None:
    ...
    print("\nUso:")
    print("  python main.py fonte")
    print("  python main.py balanceador <porta> \"ip1:porta1,ip2:porta2\"")
    print("  python main.py servico <porta> <tempo_servico_ms> <nome_modelo>")
    print("\nExemplos:")
    print("  python main.py fonte")
    print("  python main.py balanceador 2000 \"localhost:4001,localhost:4002\"")
    print("  python main.py servico 4001 50.5 \"modelo_ia_v1\"")
